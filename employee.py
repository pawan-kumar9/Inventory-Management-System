...
class employeeClass:
    def __init__(self,root):
        ...
        #===searchFrame===
        SearchFrame=LabelFrame(self.root,text="Search Employee",font=("goudy old styel",12,"bold"),bd=2,relief=RIDGE,bg="white")
        ...
        lbl_empid = Label(self.root, text="Emp ID", font=(
            "goudy old style", 15), bg="white").place(x=50, y=140)
        lbl_gender = Label(self.root, text="Gender", font=(
            "goudy old style", 15), bg="white").place(x=380, y=140)
        lbl_contact = Label(self.root, text="Contact", font=(
            "goudy old style", 15), bg="white").place(x=700, y=140)

        txt_empid = Entry(self.root,textvariable=self.var_emp_id ,font=(
            "goudy old style", 15), bg="light yellow").place(x=150, y=140,width=180)
        cmb_gender = ttk.Combobox(self.root, textvariable=self.var_gender, values=(
            "Select", "Male", "Female", "Other"), state='readonly', justify=CENTER, font=("goudy old style", 15))
        cmb_gender.place(x=465, y=140, width=180)
        cmb_gender.current(0)
        txt_contact = Entry(self.root, textvariable=self.var_contact,font=(
            "goudy old style", 15), bg="light yellow").place(x=800, y=140,width=180)

        #====row2===========
        lbl_name = Label(self.root, text="Name", font=(
            "goudy old style", 15), bg="white").place(x=50, y=180)
        lbl_dob = Label(self.root, text="D.O.B", font=(
            "goudy old style", 15), bg="white").place(x=380, y=180)
        lbl_doj = Label(self.root, text="D.O.J", font=(
            "goudy old style", 15), bg="white").place(x=700, y=180)

        txt_name = Entry(self.root, textvariable=self.var_name, font=(
            "goudy old style", 15), bg="light yellow").place(x=150, y=180, width=180)
        txt_dob = Entry(self.root, textvariable=self.var_dob, font=(
            "goudy old style", 15), bg="light yellow").place(x=465, y=180, width=180)
        txt_doj = Entry(self.root, textvariable=self.var_doj, font=(
            "goudy old style", 15), bg="light yellow").place(x=800, y=180, width=180)

        #====row3===========
        lbl_email = Label(self.root, text="Email", font=(
            "goudy old style", 15), bg="white").place(x=50, y=220)
        lbl_pass = Label(self.root, text="Password", font=(
            "goudy old style", 15), bg="white").place(x=380, y=220)
        lbl_utype = Label(self.root, text="User Type", font=(
            "goudy old style", 15), bg="white").place(x=700, y=220)

        txt_email = Entry(self.root, textvariable=self.var_email,font=(
            "goudy old style", 15), bg="light yellow").place(x=150, y=220, width=180)
        txt_pass = Entry(self.root, textvariable=self.var_pass,font=(
            "goudy old style", 15), bg="light yellow").place(x=465, y=220, width=180)
        ...
        cmb_utype.place(x=800, y=220, width=180)
        cmb_utype.current(0)
        ...
        lbl_salary = Label(self.root, text="Salary", font=(
            "goudy old style", 15), bg="white").place(x=465, y=260)

        self.txt_address = Text(self.root,font=(
            "goudy old style", 15), bg="light yellow")
        self.txt_address.place(x=150, y=260, width=300,height=60)
        txt_salary = Entry(self.root,textvariable=self.var_salary,font=(
            "goudy old style", 15), bg="light yellow").place(x=580, y=260, width=180)

        #=======buttons===========
        btn_add = Button(self.root, text="Save", command=self.add ,font=(
            "goudy old style", 15), bg="#2196f3", fg="white", cursor="hand2").place(x=465, y=300, width=110, height=28)
        btn_update = Button(self.root, text="Update",command=self.update ,font=(
            "goudy old style", 15), bg="#4caf50", fg="white", cursor="hand2").place(x=585, y=300, width=110, height=28)
        btn_delete = Button(self.root,command=self.delete ,text="Delete", font=(
            "goudy old style", 15), bg="#f44336", fg="white", cursor="hand2").place(x=705, y=300, width=110, height=28)
        btn_clear = Button(self.root,command=self.clear ,text="Clear", font=(
            "goudy old style", 15), bg="#607d8b", fg="white", cursor="hand2").place(x=825, y=300, width=110, height=28)

        #============Employee Details============
        emp_frame=Frame(self.root,bd=3,relief=RIDGE)
        emp_frame.place(x=0,y=330,relwidth=1,height=150)
        ...
        self.EmployeeTable.column("name", width=95)
        self.EmployeeTable.column("email", width=95)
        self.EmployeeTable.column("gender", width=95)
        self.EmployeeTable.column("contact", width=95)
        self.EmployeeTable.column("dob", width=95)
        self.EmployeeTable.column("doj", width=95)
        self.EmployeeTable.column("pass", width=95)
        self.EmployeeTable.column("utype", width=95)
        self.EmployeeTable.column("address", width=95)
        self.EmployeeTable.column("salary", width=95)
        ...
        try:
            if self.var_emp_id.get()=="":
                ...
                if row!=None:
                    ...
                    con.commit()
                    messagebox.showinfo("Success","Employee ID added successfully",parent=self.root)
                    self.show()
    ...
    def search(self):
        ...
        try:
            if self.var_searchby.get()=="Select":
                ...
                messagebox.showerror("Error","Search input shpuld be required",parent=self.root)
            else:
